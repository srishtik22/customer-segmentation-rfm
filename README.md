...
The most recent invoice date in the dataset was used as the reference point for recency calculation.
...
The combined RFM scores were then used for customer segmentation.
...
- A significant portion of customers were **one-time buyers**, indicating opportunities for retention strategies
...
- Targeted campaigns can help convert **New customers into Loyal customers**
- **At-Risk customers** can be re-engaged with personalized offers

---

## Conclusion
This project demonstrates how **RFM analysis** can be applied to large-scale transactional data (**400K+ rows**) to derive actionable customer insights, improve retention strategies, and support data-driven marketing decisions **without relying on predictive modeling**.
